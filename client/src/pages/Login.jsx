...
function Login({ onLoginSuccess }) { // Accept the function as a prop
    ...
    return (
        <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Avatar alt="Eco Unity Logo" src="/src/assets/logo.svg" sx={{ width: 80, height: 80, mb: 2 }} />
            ...
            {showPopup && <WelcomePopup userName={userName} onClose={handleClosePopup} />}
            <ToastContainer />
        </Box>
    );
}
